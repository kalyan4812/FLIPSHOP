...
import com.example.flipshop.models.AddModel;
...
public class AdminOffer extends AppCompatActivity {
    Button pick_img, uploadbtn;
    ImageView loadedimg;
    EditText category_name_ed, category_subtitle;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        category_subtitle = findViewById(R.id.cat_subtitle);
        ...
        storageReference = FirebaseStorage.getInstance().getReference("Category_offer");
        databaseReference = FirebaseDatabase.getInstance().getReference("Category_offer");
        ...
        pick_img.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Dexter.withActivity(AdminOffer.this)
        ...
        if (imageUri != null) {
            ...
            uploadTask.addOnFailureListener(new OnFailureListener() {
                ...
                public void onFailure(@NonNull Exception e) {
                    ...
                    Toast.makeText(AdminOffer.this, "Error: " + message, Toast.LENGTH_SHORT).show();
                    progressDialog.dismiss();
                }
            }).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                @Override
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    Toast.makeText(AdminOffer.this, "Product Image uploaded Successfully...", Toast.LENGTH_SHORT).show();
                    Task<Uri> urlTask = uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                        ...
                        public void onComplete(@NonNull Task<Uri> task) {
                            if (task.isSuccessful()) {
                                ...
                                Toast.makeText(AdminOffer.this, "got the Category image Url Successfully...", Toast.LENGTH_SHORT).show();
            ...
            Toast.makeText(AdminOffer.this, "No Picture Selected", Toast.LENGTH_SHORT).show();
            progressDialog.dismiss();
        }
    }
    ...
    private void sendData() {
        ...
        AddModel upload = new AddModel(category_name_ed.getText().toString().trim(), downloadUrl, category_subtitle.getText().toString());
        // String uploadId=databaseReference.push().getKey();
        String uploadId = category_name_ed.getText().toString();
        databaseReference.child(uploadId).setValue(upload);
        category_subtitle.setText("");
