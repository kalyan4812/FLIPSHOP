            ...
            public void onClick(View v) {
                if (!name_ed.getText().toString().equals("") && !email_ed.getText().toString().equals("") && !password_ed.getText().toString().equals("") && !confirm_pass_ed.getText().toString().equals("")){
                    ...
                    if (pass.equals(confirmpass)){
                        ...
                        Toast.makeText(AdminSignupActivity.this, "All correct", Toast.LENGTH_SHORT).show();
                        progressDialog.show();
                        //firebase program to create account
                        docRef=fstore.collection("admin").document(email_s);
                    ...
                    Toast.makeText(AdminSignupActivity.this, "All fields required. Please Fill the details", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        docRef.set(user).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()){
                    Toast.makeText(AdminSignupActivity.this, "Register Success", Toast.LENGTH_SHORT).show();
                    startActivity(new Intent(getApplicationContext(), AdminLoginActivity.class));
                    progressDialog.dismiss();
                }
                else {
                    Toast.makeText(AdminSignupActivity.this, "Failed", Toast.LENGTH_SHORT).show();
                    progressDialog.dismiss();
                }
            }
        });
